...
TriggerServerEvent("rd:infinity:player:ready")

RegisterNetEvent('rd:infinity:player:coords')
AddEventHandler('rd:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('rd:infinity:entity:coords')
AddEventHandler('rd:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('rd:infinity:entity:coords', pNetId)

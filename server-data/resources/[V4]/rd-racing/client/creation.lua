...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("rd-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    TriggerServerEvent("rd-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("rd-racing:cmd:racecreate")
AddEventHandler("rd-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("rd-racing:cmd:racecreatedone")
AddEventHandler("rd-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("rd-racing:cmd:racecreatecancel")
AddEventHandler("rd-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)

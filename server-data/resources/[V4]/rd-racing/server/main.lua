...
RPC.register("rd-racing:getAllRaces", function(pSrc)
    local src = pSrc
...
RegisterNetEvent('rd-racing:allRaces')
AddEventHandler('rd-racing:allRaces', function()
    local allRaces = {
        races = Races,
        pendingRaces = PendingRaces,
        activeRaces = ActiveRaces,
    ...
    TriggerEvent('rd-phone:allRaces', allRaces) 
end)
...
RPC.register("rd-racing:awardPlayer", function(pSrc, pAmt)
...
Citizen.CreateThread(function()
    ...
    Wait(100)
    TriggerEvent('rd-racing:allRaces')
end)

RPC.register('rd-racing:setAlias', function(src, usedItemIds, usedItemSlots, aliass)
    print("i am here")
...
RPC.register('rd-racing:giveRacingUSB', function(pSource)

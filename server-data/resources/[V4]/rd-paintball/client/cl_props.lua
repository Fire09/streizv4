...
AddEventHandler("rd-props:attachProp", function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex)
  attachProp(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex)
end)
AddEventHandler("rd-props:removeProp", function()
  removeAttachedProp()
end)

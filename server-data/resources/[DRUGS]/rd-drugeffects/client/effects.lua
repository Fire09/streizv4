...
AddEventHandler('inventory:ketamine', function(pPurity)
  ...
  TriggerServerEvent("rd-drugeffects:forceStress", 1, 3 * 60 * 1000)
  ...
  ketaActive = false
  TriggerEvent("fx:run", "cocaine", 10, 0.0, false, false)
  TriggerServerEvent("rd-drugeffects:forceStress", 5000, 10 * 60 * 1000)
end)
...
AddEventHandler('inventory:heroin', function(pPurity)
  ...
  TriggerEvent("healed:useOxy", false)
  TriggerServerEvent("rd-drugeffects:forceStress", 1, length)

...
RegisterUICallback('rd-fleeca:email_1', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('str:bankemail1')
end)

RegisterNetEvent("str:bankemail1", function()
...
RegisterUICallback('rd-fleeca:email_2', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('str:bankemail2')
end)

RegisterNetEvent("str:bankemail2", function()
...
RegisterUICallback('rd-fleeca:email_3', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('str:bankemail3')
end)

RegisterNetEvent("str:bankemail3", function()
...
RegisterUICallback('rd-fleeca:email_4', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('str:bankemail5')
end)

RegisterNetEvent("str:bankemail5", function()
...
RegisterUICallback('rd-fleeca:email_5', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('str:bankemail6')
end)

RegisterNetEvent("str:bankemail6", function()
...
RegisterUICallback('rd-fleeca:email_6', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('str:bankemail7')
end)

RegisterNetEvent("str:bankemail7", function()
...
RegisterNetEvent("str:bankemail", function(bankname)
    local username = "FLEECA"..(math.random (10000,99999))
    local password = math.random (1000000,9999999)

    TriggerServerEvent('str:usernamestore', bankname, username, password)

    TriggerServerEvent('str:fleecalogin', bankname, username, password)
...
RegisterNetEvent('rd-robbery:usb')
AddEventHandler('rd-robbery:usb', function()
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
            ...
            if closestBank ~= nil then
                ...
                if dist < 1.5 then				
                    if not Config.SmallBanks[closestBank]["isOpened"] then 
                            TriggerServerEvent('rd-heists:fleecaBankLog')
                            TriggerServerEvent("rd-heists:availabilty")
                            exports["rd-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
                            TriggerServerEvent('str:retrievelogindata', closestBank)
                            TriggerEvent("client:newStress",true,100)
                            FreezeEntityPosition(GetPlayerPed(-1), false)
                            StartHeistFleecaPanel()
                            Citizen.Wait(5000)
                            exports['rd-hacking']:hacking(
                            function()
                            ...
                            function()
                                ...
                                if math <= 40 then
                                    TriggerEvent("DoLongHudText", "You killed the HDD you fuck! Nice one.", 2)
                                    TriggerEvent('inventory:removeItem', 'heistlaptop3', 1)
                                    FreezeEntityPosition(PlayerPedId(), false)
                                    ClearPedTasksImmediately(PlayerPedId())
                                    TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3.0, 'hddpop', 1.0)
                                else 
                                    FreezeEntityPosition(PlayerPedId(), false)
                                    ClearPedTasksImmediately(PlayerPedId())
                                end 
...
RegisterNetEvent('rd-robbery:client:setBankState')
AddEventHandler('rd-robbery:client:setBankState', function(bankId, state)
...
RegisterNetEvent('rd-robbery:client:enableAllBankSecurity')
AddEventHandler('rd-robbery:client:enableAllBankSecurity', function()
    for k, v in pairs(Config.SmallBanks) do
        Config.SmallBanks[k]["alarm"] = true
    end
end)

RegisterNetEvent('rd-robbery:client:disableAllBankSecurity')
AddEventHandler('rd-robbery:client:disableAllBankSecurity', function()
    for k, v in pairs(Config.SmallBanks) do
        Config.SmallBanks[k]["alarm"] = false
    end
end)

RegisterNetEvent('rd-robbery:client:BankSecurity')
AddEventHandler('rd-robbery:client:BankSecurity', function(key, status)
...
RegisterNetEvent('rd-robbery:client:setLockerState')
AddEventHandler('rd-robbery:client:setLockerState', function(bankId, lockerId, state, bool)
    if bankId == "pacific" then	
        print('[QUEER]')
    else
...
RegisterNetEvent('rd-robbery:client:ResetFleecaLockers')
AddEventHandler('rd-robbery:client:ResetFleecaLockers', function(BankId)
...
RegisterNetEvent("fleeca:success:panel", function()
    ...
    exports["rd-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
    TriggerServerEvent('rd-robbery:server:setBankState', closestBank, true)

     if closestBank == 1 then
        print('[rd-heists] CREATE FLEECA PINK CAGE TROLLEYS')
        TriggerEvent('str:create:props:trolleys:pink:cage:bank')
     elseif closestBank == 2 then
        print('[rd-heists] CREATE FLEECA LEGION SQUARE TROLLEYS')
        TriggerEvent('str:create:props:trolleys:legion:sqaure:bank')
     elseif closestBank == 3 then
        print('[rd-heists] CREATE FLEECA HAWICK AVE TROLLEYS')
        TriggerEvent('str:create:props:trolleys:hawick:ave:bank')
     elseif closestBank == 4 then
        print('[rd-heists] CREATE FLEECA DEL PERRO TROLLEYS')
        TriggerEvent('str:create:props:trolleys:del:perrro:blvd')
     elseif closestBank == 5 then
        print('[rd-heists] CREATE FLEECA GREAT OCEAN TROLLEYS')
        TriggerEvent('str:create:props:trolleys:great:ocean:highway')
     elseif closestBank == 6 then
        print('[rd-heists] CREATE FLEECA ROUTE 68 TROLLEYS')
        TriggerEvent('str:create:props:trolleys:route:68:bank')
     end
     DeleteObject(laptop)
 end)
...
AddEventHandler("fleeca:loot", function()
    local card = exports["rd-taskbar"]:taskBar(40000,"Taking cash...")
    if card == 100 then
...
RegisterNetEvent('str:create:props:trolleys:legion:sqaure:bank')
AddEventHandler('str:create:props:trolleys:legion:sqaure:bank', function()
...
RegisterNetEvent('str:create:props:trolleys:del:perrro:blvd')
AddEventHandler('str:create:props:trolleys:del:perrro:blvd', function()
...
RegisterNetEvent('str:create:props:trolleys:great:ocean:highway')
AddEventHandler('str:create:props:trolleys:great:ocean:highway', function()
...
RegisterNetEvent('str:create:props:trolleys:pink:cage:bank')
AddEventHandler('str:create:props:trolleys:pink:cage:bank', function()
...
RegisterNetEvent('str:create:props:trolleys:hawick:ave:bank')
AddEventHandler('str:create:props:trolleys:hawick:ave:bank', function()
...
RegisterNetEvent('str:create:props:trolleys:route:68:bank')
AddEventHandler('str:create:props:trolleys:route:68:bank', function()
...
RegisterNetEvent("rd-fleeca:grab")
AddEventHandler("rd-fleeca:grab", function()

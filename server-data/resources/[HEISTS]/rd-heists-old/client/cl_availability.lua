RegisterNetEvent('rd-heists:checkAvailability')
AddEventHandler('rd-heists:checkAvailability', function() 
    ...
    exports["rd-ui"]:showContextMenu(FatCunt)
end)

RegisterNetEvent('rd-heists:purchaseHeistEquipment')
AddEventHandler('rd-heists:purchaseHeistEquipment', function()
    local HeistEquipment = {
		{
            ...
            children = {
                ...
                action = "rd-heists:purchaseGreenLaptop",
            },
        },
        {
            title = "Paleto Laptop",
            ...
            children = {
                ...
                action = "rd-heists:purchaseBlueLaptop",
            },
        },
    }
    exports["rd-ui"]:showContextMenu(HeistEquipment)
end)

RegisterUICallback('rd-heists:purchaseGreenLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['rd-inventory']:hasEnoughOfItem('heistusb5', 1) then
        TriggerEvent('inventory:removeItem', 'heistusb5', 1)
        TriggerEvent("player:receiveItem", "heistlaptop3", 1)
    end
end)

RegisterUICallback('rd-heists:purchaseBlueLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['rd-inventory']:hasEnoughOfItem('heistusb1', 1) then

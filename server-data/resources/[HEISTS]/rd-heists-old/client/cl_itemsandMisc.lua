...
local function isNightTime()
  local isNight = exports["rd-weathersync"]:isNightTime()
  return isNight
end
...
AddEventHandler("rd-inventory:itemUsed", function(item, passedItemInfo, inventoryName, slot)
  ...
  local currentBattery = meta.battery or 600
...
Citizen.CreateThread(function()
  exports["rd-keybinds"]:registerKeyMapping("", "Player", "Toggle Thermals", "+toggleThermalMode", "-toggleThermalMode", "END")
...
AddEventHandler("rd-inventory:itemUsed", function(item)
  ...
  local hasItem1 = exports["rd-inventory"]:hasEnoughOfItem("casinocaseaccesshalf", 1, false, true)
  local hasItem2 = exports["rd-inventory"]:hasEnoughOfItem("casinocaseaccesshalfsecond", 1, false, true)
...
AddEventHandler("rd-inventory:itemUsed", function(pItem)
  ...
  Citizen.CreateThread(function()
    ...
    Wait(200)
    TriggerEvent("rd-props:attachProp", "np_wingsuit_open", 24817, 0.1, -0.15, 0.0, 0.0, 90.0, 0.0, true, true, "np_wingsuit_open")
  end)
  Citizen.CreateThread(function()
  ...
  Citizen.CreateThread(function()
    ...
    TriggerEvent("rd-props:removePropByName", "np_wingsuit_open")
    wingsuiting = false
  end)
  Citizen.CreateThread(function()
    while not IsPedInParachuteFreeFall(playerPed) do
...
AddEventHandler("rd-inventory:itemUsed", function(pItem)
  ...
  Citizen.CreateThread(function()
    TriggerEvent("inventory:removeItem", pItem, 1)
    Wait(200)
    TriggerEvent("rd-props:attachProp", "np_wingsuit_b_open", 24817, 0.1, -0.15, 0.0, 0.0, 90.0, 0.0, true, true, "np_wingsuit_b_open")
  end)
  Citizen.CreateThread(function()
    SetPlayerParachuteModelOverride(PlayerId(), `p_parachute1_mp_s`)
    SetPedParachuteTintIndex(playerPed, 6)
  ...
  Citizen.CreateThread(function()
    ...
    TriggerEvent("rd-props:removePropByName", "np_wingsuit_b_open")
    wingsuiting = false
  end)
  Citizen.CreateThread(function()
    while not IsPedInParachuteFreeFall(playerPed) do

...
local function loopSkill(count)
    ...
    while loopCount < count do
        ...
        local finished = exports["rd-ui"]:taskBarSkill(math.random(1400, 5000), math.random(7, 12))
...
AddEventHandler("rd-heists:breakInToRegister", function(pArgs, pEntity)
...
Citizen.CreateThread(function()
  exports["rd-interact"]:AddPeekEntryByModel({ 303280717 }, {{
    event = "rd-heists:breakInToRegister",
    id = "rd-heists:breakInToRegister",
    icon = "hammer",
    label = "Smash!",
    parameters = {},
  }}, {

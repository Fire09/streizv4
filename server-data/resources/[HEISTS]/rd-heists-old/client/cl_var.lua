RegisterNetEvent('rd-heists:door_thermite')
AddEventHandler('rd-heists:door_thermite', function()
    TriggerServerEvent('rd-heists:thermite_var')
end)

exports["rd-polytarget"]:AddBoxZone("var_heist1",  vector3(-209.03, -302.76, 74.48), 1, 1, {
    heading=340,
    --debugPoly=false,
    minZ=71.68,
    maxZ=75.68
...
exports["rd-interact"]:AddPeekEntryByPolyTarget("var_heist1", {{
    event = "rd-heists:door_thermite",
    id = "var_heist1",
    icon = "circle",
    label = "Blow me...", 
    parameters = {},
...
RegisterNetEvent('rd-heists:var_door_to_lobby')
AddEventHandler('rd-heists:var_door_to_lobby', function()
    ...
    if distance < 1.5 then
        if exports["rd-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
            ...
            exports['rd-thermite']:OpenThermiteGame(function(success)
                if success then
                    TriggerServerEvent('rd-heists:var_thermite')
                    TriggerEvent('rd-hud:hide_hackerman')
                    TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                    TriggerServerEvent('rd-doors:change-lock-state', 573, false) 
                    Citizen.Wait(3000)
...
exports["rd-polytarget"]:AddCircleZone("var_computer_1",  vector3(-212.7, -298.21, 74.49), 0.35, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_computer_1", {
    {
        event = "rd-heists:var_event_1",
        id = "var_computer_1",
        icon = "user-secret",
...
RegisterNetEvent('rd-heists:var_event_1')
AddEventHandler('rd-heists:var_event_1', function()
    TriggerServerEvent('rd-heists:in_var_1_srv')
end)

RegisterNetEvent('rd-heists:enter_var_location_1')
AddEventHandler('rd-heists:enter_var_location_1', function()
    if exports['rd-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
...
exports["rd-polytarget"]:AddCircleZone("var_computer_2",  vector3(-211.2, -301.14, 74.49), 0.45, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_computer_2", {
    {
        event = "rd-heists:var_event_2",
        id = "var_computer_2",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('rd-heists:var_event_2')
AddEventHandler('rd-heists:var_event_2', function()
    TriggerServerEvent('rd-heists:in_var_2_srv')
end)

RegisterNetEvent('rd-heists:enter_var_location_2')
AddEventHandler('rd-heists:enter_var_location_2', function()
    if exports['rd-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["rd-polytarget"]:AddCircleZone("var_computer_3",  vector3(-206.6, -297.19, 74.49), 0.45, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_computer_3", {
    {
        event = "rd-heists:var_event_3",
        id = "var_computer_3",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('rd-heists:var_event_3')
AddEventHandler('rd-heists:var_event_3', function()
    TriggerServerEvent('rd-heists:in_var_3_srv')
end)

RegisterNetEvent('rd-heists:enter_var_location_3')
AddEventHandler('rd-heists:enter_var_location_3', function()
    if exports['rd-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["rd-polytarget"]:AddCircleZone("var_computer_4",  vector3(-207.02, -294.14, 74.49), 0.5, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_computer_4", {
    {
        event = "rd-heists:var_event_4",
        id = "var_computer_4",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('rd-heists:var_event_4')
AddEventHandler('rd-heists:var_event_4', function()
    TriggerServerEvent('rd-heists:in_var_4_srv')
end)

RegisterNetEvent('rd-heists:enter_var_location_4')
AddEventHandler('rd-heists:enter_var_location_4', function()
    if exports['rd-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["rd-polytarget"]:AddCircleZone("var_computer_5",  vector3(-209.4, -293.28, 74.49), 0.4, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_computer_5", {
    {
        event = "rd-heists:var_event_5",
        id = "var_computer_5",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('rd-heists:var_event_5')
AddEventHandler('rd-heists:var_event_5', function()
    TriggerServerEvent('rd-heists:in_var_5_srv')
end)

RegisterNetEvent('rd-heists:enter_var_location_5')
AddEventHandler('rd-heists:enter_var_location_5', function()
    if exports['rd-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
AddEventHandler('varhack:1', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('rd-heists:hackfalse')
        else
...
TriggerServerEvent('rd-heists:hack1')
end)


exports["rd-polytarget"]:AddCircleZone("var_hack1",  vector3(2167.94, 2925.92, -81.38), 0.5, {
    useZ = true
})


exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack1", {
    {
...
AddEventHandler('varhack:2', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('rd-heists:hackfalse2')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail1')
          print("lol")
...
TriggerServerEvent('rd-heists:hack2')
end)

exports["rd-polytarget"]:AddCircleZone("var_hack2",  vector3(2135.66, 2901.72, -84.27), 0.53, {
    useZ = true
})


exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack2", {
    {
...
AddEventHandler('varhack:3', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('rd-heists:hackfalse3')
        else
...
TriggerServerEvent('rd-heists:hack3')
end)

exports["rd-polytarget"]:AddCircleZone("var_hack3",  vector3(2171.24, 2927.76, -81.38), 0.41, {
    useZ = true
})


exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack3", {
    {
...
AddEventHandler('varhack:4', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('rd-heists:hackfalse4')
        else
            TriggerEvent('voidrp:varcreatepedfail2')
        end
      end, 7, 6)
...
TriggerServerEvent('rd-heists:hack4')
end)

exports["rd-polytarget"]:AddCircleZone("var_hack4",  vector3(2087.82, 2946.72, -84.22), 0.53, {
    useZ = true
})


exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack4", {
    {
...
AddEventHandler('varhack:5', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('rd-heists:hackfalse5')
        else
...
TriggerServerEvent('rd-heists:hack5')
end)

exports["rd-polytarget"]:AddCircleZone("var_hack5",  vector3(2174.89, 2927.76, -81.38), 0.4, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack5", {
    {
...
AddEventHandler('varhack:6', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('rd-heists:hackfalse6')
        else
            TriggerEvent('voidrp:varcreatepedfail')
        end
      end, 8, 7)
...
TriggerServerEvent('rd-heists:hack6')
end)

exports["rd-polytarget"]:AddCircleZone("var_hack6",  vector3(2327.77, 2945.95, -84.47), 0.55, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack6", {
    {
...
AddEventHandler('varhack:7', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('rd-heists:hackfalse7')
...
if exports["rd-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('rd-heists:hack7')
end 
end)

exports["rd-polytarget"]:AddCircleZone("var_hack7",  vector3(2185.9, 2913.24, -84.8), 0.5, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack7", {
    {
...
AddEventHandler('varhack:8', function()
    exports['rd-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('rd-heists:hackfalse8')
            TriggerEvent("inventory:removeItem", "varusb", 1)
            TriggerEvent('player:receiveItem', 'heistusb1', 1)
            --TriggerEvent("player:receiveItem", "fleecaDocsUSB", 1)
        else
            TriggerEvent('voidrp:varcreatepedfail')
        end
      end, 15, 10)
...
if exports["rd-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('rd-heists:hack8')
end 
end)

exports["rd-polytarget"]:AddCircleZone("var_hack8",  vector3(2185.94, 2928.69, -84.8), 0.5, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("var_hack8", {
    {
...
exports["rd-polytarget"]:AddCircleZone("leave",  vector3(2156.4, 2922.22, -81.08), 0.5, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("leave", {
    {
...
TriggerServerEvent('rd-leavevar2')
end)
...
AddEventHandler('exit:varcompleteheist', function()
  ...
  TriggerEvent('str:admin:ReviveInDistance')
  Citizen.Wait(1000)
end)
...
RegisterNetEvent('rd-heists:loot_peds')
AddEventHandler('rd-heists:loot_peds', function()
...
RegisterNetEvent('rd-heists:var_loot_ped')
AddEventHandler('rd-heists:var_loot_ped', function()
    if isPlayerInVar == 1 then
        TriggerEvent('rd-heists:loot_peds')
        TriggerServerEvent('rd-var:lootcooldown')
    else
        print('cooldown')
    end
end) 

RegisterNetEvent('rd-heists:svclientloot')
AddEventHandler('rd-heists:svclientloot', function()
    TriggerServerEvent('rd-evannicxvar:varlootcooldown')
end)
 
function removevarmedkits()
    local qty = exports["rd-inventory"]:getQuantity("varmedkit")
...
function removevpistolammo()
    local qty = exports["rd-inventory"]:getQuantity("pistolammo")
    if qty and qty > 0 then
...
function removevsubammo()
    local qty = exports["rd-inventory"]:getQuantity("subammo")
    if qty and qty > 0 then
...
function removevrifleammo()
    local qty = exports["rd-inventory"]:getQuantity("rifleammo")
    if qty and qty > 0 then
...
AddEventHandler("rd-heists:serverroom:revivePlayer", function(pEntity)
    local ped = PlayerPedId()
    KneelMedic()
    local finished = exports["rd-taskbar"]:taskBar(7500,"Helping Person Up...")
...
AddEventHandler('revive_var', function(pEntity)
    ...
    TriggerClientEvent('rd-hospital:client:RemoveBleed', target) 
    TriggerClientEvent('rd-hospital:client:ResetLimbs', target)
end) 

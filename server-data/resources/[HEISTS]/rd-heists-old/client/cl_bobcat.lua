...
RegisterNetEvent('rd-bobcat:firstdoor')
AddEventHandler('rd-bobcat:firstdoor', function()
    ...
    local distance = #(vector3(882.208, -2258.1, 30.541439) - player)
        if distance < 1.5 then
            if exports["rd-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                frontdoor()
                TriggerServerEvent('rd-heists:bobcatLog')
                TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                exports['rd-thermite']:OpenThermiteGame(function(success)  
                    if success then
                        TriggerServerEvent('rd-doors:change-lock-state', 272, false) 
                        TriggerServerEvent("rd-doors:change-lock-state", 273, false)
                        exports["rd-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
                        TriggerServerEvent("str:particleserver", method)
                        Citizen.Wait(5000)
...
RegisterNetEvent('rd-bobcat:seconddoor')
AddEventHandler('rd-bobcat:seconddoor', function()
local player = GetEntityCoords(PlayerPedId())
        ...
        if exports["rd-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['rd-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        --Door IDS
                        TriggerServerEvent("rd-doors:change-lock-state", 274, false)
                        exports["rd-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
                        Citizen.Wait(3000)
                    else
                        Citizen.Wait(2000)
...
RegisterNetEvent('rd-heists:bobcat_armed_door')
AddEventHandler('rd-heists:bobcat_armed_door', function()
    ...
    local Dist = #(vector3(883.02, -2268.0, 30.47) - PlyPed)
        if Dist < 1.5 then
            ...
            TriggerEvent('rd-heists:bobcat_explosion_ped')
            FreezeEntityPosition(PlayerPedId(), true)
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerServerEvent("rd-doors:change-lock-state", 276, false)
            TriggerServerEvent("rd-doors:change-lock-state", 277, false)
    else
        TriggerEvent('DoLongHudText', 'Not enough cops on duty', 2)
    end
end)
...
RegisterNetEvent("bobcat:success:panel", function()
    TriggerEvent('DoLongHudText', "Success!", 1)
    TriggerServerEvent("rd-doors:change-lock-state", 275, false)
    TriggerServerEvent("rd-doors:change-lock-state", 276, false)
    exports["rd-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
end)
...
RegisterNetEvent('rd-bobcat:bubbles')
...
RegisterNetEvent('blow_door', function()
    TriggerServerEvent('rd-heists:bobcatLog')
    TriggerServerEvent('rd-bobcat:blow_door')
end)

RegisterNetEvent('rd-heists:bobcat_explosion_ped')
AddEventHandler('rd-heists:bobcat_explosion_ped', function()
...
RegisterNetEvent('rd-heists:explosion_ped_walk') -- PED WALK
AddEventHandler('rd-heists:explosion_ped_walk', function()
    exports["rd-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
...
AddEventHandler('lumo:client:requestblast', function()
	TriggerServerEvent("rd-bobcat:request_door")
end)
...
AddEventHandler('lumo:pedbomb', function()
    ...
    TriggerServerEvent("rd-bobcat:bubbles")
    -- TriggerEvent("lumo:propcreate")
    Wait(1500)
end)


RegisterNetEvent('rd-bobcat:search_crate_1unchecked') -- PED WALK
AddEventHandler('rd-bobcat:search_crate_1unchecked', function()
    TriggerServerEvent("rd-bobcat:search_crate_1")
end)

RegisterNetEvent('rd-bobcat:search_crate_2unchecked') -- PED WALK
AddEventHandler('rd-bobcat:search_crate_2unchecked', function()
    TriggerServerEvent("rd-bobcat:search_crate_2")
end)

RegisterNetEvent('rd-bobcat:search_crate_3unchecked') -- PED WALK
AddEventHandler('rd-bobcat:search_crate_3unchecked', function()
    TriggerServerEvent("rd-bobcat:search_crate_3")
end)

RegisterNetEvent('rd-bobcat:search_crate_1') 
AddEventHandler('rd-bobcat:search_crate_1', function()
    FreezeEntityPosition(GetPlayerPed(-1),true)
    TriggerEvent("doAnim","search")
    exports["rd-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
    local finished = exports["rd-taskbar"]:taskBar(30000,"Looting")
    if finished == 100 then
        TriggerEvent('rd-heists:bobcat_loot')
...
RegisterNetEvent('rd-bobcat:search_crate_2') 
...
RegisterNetEvent('rd-bobcat:search_crate_3')
...
RegisterNetEvent('rd-heists:bobcat_loot')
AddEventHandler('rd-heists:bobcat_loot', function()
...
RegisterNetEvent("str:ptfxparticle")
AddEventHandler("str:ptfxparticle", function(method)
    local ptfx
...
AddEventHandler("rd-inventory:itemUsed", function(item)
    if item == "thermitecharge" then
        TriggerEvent('rd-bobcat:firstdoor')
        TriggerEvent('rd-bobcat:seconddoor') 
    end
end)

AddEventHandler("rd-inventory:itemUsed", function(item)
    if item == "bobcatsecuritycard" then
        TriggerEvent('rd-heists:bobcat_armed_door')
    end
end)
...
exports["rd-polytarget"]:AddCircleZone("np_bobcat_loot_1",  vector3(886.61, -2287.32, 29.92), 1.0, {
    useZ = true,
})

exports["rd-polytarget"]:AddCircleZone("np_bobcat_loot_3",  vector3(881.4, -2282.62, 30.42), 1.0, {
    useZ = true,
})

exports["rd-polytarget"]:AddCircleZone("np_bobcat_loot_2",  vector3(882.49, -2286.17, 30.37), 1.0, {
    useZ = true,
})

exports["rd-interact"]:AddPeekEntryByPolyTarget('np_bobcat_loot_1', {{
    id = "np_bobcat_loot_1",
    event = "rd-bobcat:search_crate_1unchecked",
    icon = "circle",
    label = "Loot!",
    paramers = {},
}}, { distance = { radius = 3.5 }  })

exports["rd-interact"]:AddPeekEntryByPolyTarget('np_bobcat_loot_2', {{
    id = "np_bobcat_loot_2",
    event = "rd-bobcat:search_crate_2unchecked",
    icon = "circle",
    label = "Loot!",
    paramers = {},
}}, { distance = { radius = 3.5 }  })

exports["rd-interact"]:AddPeekEntryByPolyTarget('np_bobcat_loot_3', {{
    id = "np_bobcat_loot_3",
    event = "rd-bobcat:search_crate_3unchecked",
    icon = "circle",
    label = "Loot!",
    paramers = {},
}}, { distance = { radius = 3.5 }  })

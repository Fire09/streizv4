...
function goNormalMode()
    TriggerEvent('rd-clothing:applyCurrentClothing')
end
...
RegisterNetEvent("rd-admin:horse", function(pOn)
    if not pOn then
        inHorseMode = false
...
RegisterCommand("rd-admin:horseon", function()
    TriggerServerEvent("rd-admin:shorseon")
end, false)
RegisterCommand("rd-admin:horseoff", function()
    TriggerServerEvent("rd-admin:shorseoff")
end, false)

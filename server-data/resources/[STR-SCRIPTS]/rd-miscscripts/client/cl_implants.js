...
on('rd-inventory:itemUsed', (pItemId, pItemInfo) => {
...
ImplantItem['microchipimplant'] = async (pItemId, pItemInfo) => {
    ...
    STX.Procedures.execute('rd-miscscripts:implant:installed', pItemInfo);

    await new Promise((resolve) => setTimeout(resolve, 1000))

    exports['rd-fx'].PlayEntitySound(PlayerPedId(), "Beep_Green", "DLC_HEIST_HACKING_SNAKE_SOUNDS", 1);

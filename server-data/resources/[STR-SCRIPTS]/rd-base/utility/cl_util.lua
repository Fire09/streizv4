function STX.Util.MissionText(self, text, time)
...
function STX.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function STX.Util.DrawText3D(self, x,y,z, text)
...
function STX.Util.RotationToDirection(self,rotation)
...
function STX.Util.ScreenRelToWorld(self,camPos,camRot,coord)

      local distance = 1000.0
      local camForward = STX.Util.RotationToDirection(self,camRot);
      ...
      local camRight = STX.Util.RotationToDirection(self,rotRight) - STX.Util.RotationToDirection(self,rotLeft);
      local camUp = STX.Util.RotationToDirection(self,rotUp) - STX.Util.RotationToDirection(self,rotDown);
...
STX.Util.GetPlayersInArea = function(coords, area)
	return enumerateInArea(STX.Util.GetPlayers(), coords, area)
end

STX.Util.GetPlayers = function()
	local maxPlayers = 24
	local players    = {}

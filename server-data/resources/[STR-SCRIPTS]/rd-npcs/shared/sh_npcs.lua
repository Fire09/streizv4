...
Generic.ShopKeeperLocations = {
  ...
  vector4(291.8556, -1272.999, 28.43, 1.344),
  vector4(812.4072, -782.9655, 25.17, 268.0781)
}
...
Generic.pdArmoryNpcs = {
  ...
  vector4(-1077.97,-830.33,18.31,317.59),
...
Generic.NPCS[#Generic.NPCS + 1] = {
  ...
  distance = 50.0,
  position = {
    coords = vector3(-212.9027, -1364.778, 30.29),
    heading = 31.197,
},
  appearance = nil,
  settings = {
...
Generic.NPCS[#Generic.NPCS + 1] = {
  ...
  distance = 25.0,
  position = {
    coords = vector3(-599.85,2091.96,130.27),
    heading = 0.64,
    random = false
  },
  appearance = nil,
...
Generic.NPCS[#Generic.NPCS + 1] = {
  id = "drift_car_rental",
  name = "Dift Car Rental",
  pedType = 4,
  model = "cs_barry",
  networked = false,
  distance = 150.0,
  position = {
    coords = vector3(-126.7681, -2530.622, 5.0968894),
    heading = 234.80123,
    random = false
  },
  appearance = nil,

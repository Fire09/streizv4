    ...
    data = {
        {
            ...
            icon = "user-secret",
            event = "rd-police:vehicle:forceTrunkCheck",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            ...
            and exports["rd-vehicles"]:HasVehicleKey(pEntity) and exports["rd-inventory"]:hasEnoughOfItem("fakeplate", 1, false, true)
            and not exports["rd-vehicles"]:GetVehicleMetadata(pEntity, 'fakePlate')
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 3.0 },
        isEnabled = function(pEntity, pContext)
            return (not IsPedInAnyVehicle(PlayerPedId(), false) and GetBoneDistance(pEntity, 2, 'wheel_rf') <= 1.7 and pContext.model == GetHashKey("mule") and exports["rd-inventory"]:hasEnoughOfItem("homemadekey", 1, false)  )
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 3.0 },
        isEnabled = function(pEntity, pContext)
            return (not IsPedInAnyVehicle(PlayerPedId(), false) and GetBoneDistance(pEntity, 2, 'wheel_rf') <= 1.7 and pContext.model == GetHashKey("mule") and not exports["rd-inventory"]:hasEnoughOfItem("homemadekey", 1, false)  )
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            ...
            and exports["rd-vehicles"]:HasVehicleKey(pEntity) and exports["rd-vehicles"]:GetVehicleMetadata(pEntity, 'fakePlate')
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "wrench",
            event = "rd:vehicles:examineVehicle",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "eye-slash",
            event = "rd-boosting:scratchVehicleVin",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "eye-slash",
            event = "rd-meth:dropoff:cancelDropOff",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cubes",
            event = "rd-meth:dropoff:doDropoff",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "wheelchair",
            event = "rd:vehicle:wheelchair:control",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            event = "rd-jobs:sanitationWorker:vehicleTrash",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Grab goods",
            icon = "box",
            event = "rd-jobs:247delivery:takeGoods",
            parameters = {}
        }
    },
    options = {
  ...
  data = {
      {
          ...
          event = "rd-ottosauto:vehicle:transaction",
          parameters = {
            business = "ottos_auto",
            action = "sell"
          }
    ...
    data = {
        {
            ...
            label = _L("interact-sell-vehicle-ottos", "sell vehicle"),
            icon = "money-check-alt",
            FYXEvent = "rd-ottosauto:vehicle:transaction",
            parameters = {
              business = "tuner",
              action = "sell"
            }
...
Entries[#Entries + 1] = {
  ...
  options = {
      distance = { radius = 1.8 },
      isEnabled = function(pEntity, pContext)
        return polyChecks.ottosAuto.isInside and hasJobPermission("ottos_auto", "buy_car") 
      end
  }
}
    ...
    data = {
        {
            ...
            icon = "unlink",
            event = "rd-vehicles:checkTampering",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "shopping-cart",
            event = "rd-police:client:openRhinoArmoy",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cut",
            event = "rd-miscscripts:carBombs:removeBomb",
            parameters = {}
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "plus",
            event = "rd-car-clothing:saveCurrentOutfit",
            parameters = {},
        },
        {
            ...
            icon = "redo",
            event = "rd-car-clothing:swapCurrentOutfit",
            parameters = {},
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "eye-slash",
            event = "rd-heroin:seeds:cancelSeeds",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cubes",
            event = "rd-heroin:seeds:doDropoff",
            parameters = {}
        }
    },
    options = {
...
--           label = "Use Thermite",
--           icon = "circle",
--           event = "rd-heists:bobcatThermiteMoneyTruckDoor",
--           parameters = {}
--       }
--   },
--   options = {
...
--             and exports["rd-inventory"]:hasEnoughOfItem("thermitecharge", 1, false, true)
--       end
--   }
-- }
...
--           label = "Take Goods",
--           icon = "circle",
--           event = "rd-heists:bobcatMoneyTruckTakeGoods",
--           parameters = {}
--       }
--   },
--   options = {

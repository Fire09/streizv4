...
Citizen.CreateThread(function()
  exports["rd-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('rd-propattach:attach')
AddEventHandler('rd-propattach:attach', function(pPropItem, pTargetFunction)

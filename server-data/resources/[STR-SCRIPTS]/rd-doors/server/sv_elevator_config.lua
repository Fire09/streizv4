--Example : 
    ...
    ELEVATOR_CONFIG = {
...

        {
            ...
            floors = {
                {
                    name = "Central Hospital Garage",
                    description = "Garage",
                    teleport = {
                        coords = vector3(319.5394, -1421.358, 29.91),
                        heading = 0,
                        onArriveEvent = "",
                        onLeaveEvent = "",
                    },
                    ...
                    forceUnlocked = false,
                    zone = {
                        center = vector3(317.5809, -1421.899, 30.10),
                        width = 0.4,
                        length = 0.2,
                        options = {
                            minZ=28.6,
                ...
                },
                {
                    ...
                    description = "Main Floor",
                    teleport = {
                        coords = vector3(346.2563, -1410.193, 32.51),
                        heading = 0,
                        onArriveEvent = "",
                        onLeaveEvent = "",
                    },
                    ...
                    forceUnlocked = false,
                    zone = {
                        center = vector3(345.4883, -1408.177, 32.58),
                        width = 0.4,
                        length = 0.2,
                        options = {
                            minZ=28.85,
                ...
                {
                    name = "Central Hospital Top",
                    description = "Top Floor",
                    teleport = {
                        coords = vector3(340.5679, -1423.864, 46.50),
                        heading = 0,
                        onArriveEvent = "",
                        onLeaveEvent = "",
                    },
                    ...
                    forceUnlocked = false,
                    zone = {
                        center = vector3(338.1187, -1424.959, 46.55),
                        width = 0.4,
                        length = 0.2,
                        options = {
                            minZ=44.85,

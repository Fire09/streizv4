...
AddEventHandler("boosting:VehicleQB", function(vehicle, plate)    
    ...
    exports['rd-fuel']:SetFuel(veh, 100)
    SetVehicleNumberPlateText(veh, plate)
    TriggerEvent("vehicle:keys:addNew",veh,GetVehicleNumberPlateText(veh))
...
function vehicleUnlock(vehicleHandle)
    ...
    TriggerEvent("vehicle:keys:addNew",vehicleHandle,GetVehicleNumberPlateText(vehicleHandle))
end

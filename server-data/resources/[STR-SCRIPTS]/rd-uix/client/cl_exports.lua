...
RegisterNetEvent("rd-uix:open-application")
AddEventHandler("rd-uix:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("rd-uix:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("rd-uix:soundPlay")
AddEventHandler("rd-uix:soundPlay", function(name, volume, loop)

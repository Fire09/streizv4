...
function ConnectToDTFrequency(pIsHeadset)
    local subscribers = RPC.execute("rd-voice:drivethru:subscribe")
...
function DisconnectFromDTFrequency()
    ...
    RPC.execute("rd-voice:drivethru:unsubscribe")
    DTIsHeadset = false
...
function LoadDTModule()
    ...
    exports["rd-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Push-To-Talk", "+transmitToDriveThru", "-transmitToDriveThru")
    ...
    exports["rd-keybinds"]:registerKeyMapping("", "DriveThru Headset", "On / Off", "+toggleDTRadioState", "-toggleDTRadioState")
    ...
    exports["rd-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Volume Up", "+increaseDTVolume", "-increaseDTVolume")
    RegisterCommand("+increaseDTVolume", IncreaseDTRadioVolume, false)
    RegisterCommand("-increaseDTVolume", function() end, false)

    exports["rd-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Volume Down", "+decreaseDTRadioVolume", "-decreaseDTRadioVolume")
    ...
    RegisterNetEvent("rd-voice:drivethru:connect", ConnectToDTFrequency)

    RegisterNetEvent("rd-voice:drivethru:disconnect", DisconnectFromDTFrequency)

    RegisterNetEvent("rd-voice:drivethru:setPowerState", SetDTRadioPowerState)

    RegisterNetEvent("rd-voice:drivethru:addSubscriber", AddDTSubscriber)

    RegisterNetEvent("rd-voice:drivethru:removeSubscriber", RemoveDTSubscriber)

    -- scuffed way of overriding vanilla keybind
    AddEventHandler("rd:voice:transmissionStarted", function()

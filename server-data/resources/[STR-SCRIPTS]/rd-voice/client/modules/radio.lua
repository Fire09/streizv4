...
function SetRadioFrequency(pFrequency, pSendAppEvent)
    if CanUseFrequency(pFrequency, true) then
      ...
      exports["rd-hud"]:sendAppEvent("game", { radioChannel = tostring(pFrequency) })
      if pSendAppEvent then
        exports["rd-hud"]:sendAppEvent("radio", { value = pFrequency })
      end
...
function SetRadioChannel(radioID)
    ...
    exports["rd-hud"]:sendAppEvent("game", { radioChannel = tostring(radioID) })
...
function StartTransmission()
    ...
    if not IsTalkingOnRadio then
        ...
        TriggerEvent("rd:voice:transmissionStarted", { radio = true })
...
function LoadRadioModule()
    ...
    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "Push-To-Talk", "+transmitToRadio", "-transmitToRadio", "CAPITAL")
    RegisterCommand('+transmitToRadio', StartTransmission, false)
    RegisterCommand('-transmitToRadio', StopTransmission, false)

    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "Push-To-Talk (Secondary)", "+secondaryTransmitToRadio", "-secondaryTransmitToRadio")
    ...
    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "Volume Up", "+increaseRadioVolume", "-increaseRadioVolume")
    RegisterCommand('+increaseRadioVolume', IncreaseRadioVolume, false)
    RegisterCommand('-increaseRadioVolume', function() end, false)

    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "Volume Down", "+decreaseRadioVolume", "-decreaseRadioVolume")
    RegisterCommand('+decreaseRadioVolume', DecreaseRadioVolume, false)
    RegisterCommand('-decreaseRadioVolume', function() end, false)

    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "On / Off", "+toggleRadioState", "-toggleRadioState")
    ...
    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "Channel Up", "+increaseRadioChannel", "-increaseRadioChannel")
    RegisterCommand('+increaseRadioChannel', increaseRadioChannel, false)
    RegisterCommand('-increaseRadioChannel', function() end, false)

    exports["rd-keybinds"]:registerKeyMapping("", "Radio", "Channel Down", "+decreaseRadioChannel", "-decreaseRadioChannel")
    RegisterCommand('+decreaseRadioChannel', decreaseRadioChannel, false)
    RegisterCommand('-decreaseRadioChannel', function() end, false)

    RegisterNetEvent("rd:voice:radio:connect")
    AddEventHandler("rd:voice:radio:connect", ConnectToRadio)

    RegisterNetEvent("rd:voice:radio:disconnect")
    AddEventHandler("rd:voice:radio:disconnect", DisconnectFromRadio)

    RegisterNetEvent("rd:voice:radio:added")
    AddEventHandler("rd:voice:radio:added", AddRadioSubscriber)

    RegisterNetEvent("rd:voice:radio:removed")
    AddEventHandler("rd:voice:radio:removed", RemoveRadioSubscriber)

    RegisterNetEvent("rd:voice:radio:power")
    AddEventHandler("rd:voice:radio:power", SetRadioPowerState)

    RegisterNetEvent("rd:voice:radio:volume")
    AddEventHandler("rd:voice:radio:volume", SetRadioVolume)
    ...
    TriggerEvent("rd:voice:radio:ready")

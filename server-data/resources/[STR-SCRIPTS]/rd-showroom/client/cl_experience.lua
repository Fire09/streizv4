...
RegisterNUICallback("rd-ui:application-closed", function(data, cb)
  ...
  Citizen.CreateThread(function()
    ...
    DeleteEntity(vehicle)
	TriggerServerEvent('rd-showrooms:exit_instance')
  end)
end)
...
RegisterNUICallback("rd-ui:showroomChangeCar", function(data, cb)
...
AddEventHandler("rd-showroom:enterExperience", function()  
  openShowroom("pdm")
  SetNuiFocus(true, true)
end)

Citizen.CreateThread(function()
  exports["rd-interact"]:AddPeekEntryByModel({ 1723506536 }, {{
...
RegisterCommand("tunerac", function()
  TriggerEvent("rd-tunercatty")
end)

RegisterNetEvent('rd-tunercatty')
AddEventHandler('rd-tunercatty', function()
	local InstanceData = math.random(1, 1000)
		TriggerServerEvent('rd-showrooms:enter_instance', InstanceData)
		TriggerEvent('rd-showroom:enterExperience')
end)
...
RegisterNetEvent('rd:dances:dance')
AddEventHandler('rd:dances:dance', function(pDance)
...
RegisterCommand('dance', function(source, args)
    ...
    if not sex or sex == nil or sex == "" then
     TriggerEvent('rd:dances:dance', -1)
    else
        TriggerEvent('rd:dances:dance', tonumber(args[1]))
    end
end)
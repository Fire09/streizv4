...
function AlertSuspicious()
  ...
  --   }
  -- })
  exports["rd-dispatch"]:dispatchadd(dispatchCode, "Suspicious Activity")
  ...
  if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
    ...
    exports["rd-dispatch"]:dispatch(dispatchCode, "Suspicious Activity", vehicleData.plate, plyPos, vehicleData.model)
  end
end
...
function DrugSale()
  ...
  if checkedLocations() then
    ...
    --   }
    -- })
    exports["rd-dispatch"]:dispatchadd(dispatchCode, "Drug Trafficking")
    Wait(math.random(5000,15000))
    ...
    if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
      ...
      --   }
      -- })
      exports["rd-dispatch"]:dispatch(dispatchCode, "Drug Trafficking", vehicleData.plate, plyPos, vehicleData.model)
    end
end
...
function DrugUse()
  ...
  if checkedLocations() then
    ...
    --   }
    -- })
    exports["rd-dispatch"]:dispatchadd(dispatchCode, "Illegal Substance Use")
    ...
    if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
      ...
      --   }
      -- })
      exports["rd-dispatch"]:dispatch(dispatchCode, "Illegal Substance Use", vehicleData.plate, plyPos, vehicleData.model)
    end
end
...
function CarCrash()
  ...
  exports["rd-dispatch"]:dispatchadd(dispatchCode, "Car Crash")
  ...
  if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle and job == "police" then
    ...
    exports["rd-dispatch"]:dispatch(dispatchCode, "Car Crash", vehicleData.plate, plyPos, vehicleData.model)
  end
end
...
function AlertDeath()
  ...
  --   }
  -- })
  exports["rd-dispatch"]:dispatchadd(dispatchCode, "player dead") -- changer later
end
...
function AlertFight()
  ...
  exports["rd-dispatch"]:dispatchadd(dispatchCode, "Fight in progress") 
  Wait(math.random(5000,15000))
  ...
  if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
    ...
    --   }
    -- })
    exports["rd-dispatch"]:dispatch(dispatchCode, "Street Fight", vehicleData.plate, plyPos, vehicleData.model)
...
function AlertDeadlyWeapon()
  ...
  --   }
  -- })
  exports["rd-dispatch"]:dispatchadd(dispatchCode, "Deadly Weapon") 
end
...
function AlertCheckLockpick(object)
    ...
    if not DoesEntityExist(targetVehicle) then
      ...
      --   }
      -- })
      exports["rd-dispatch"]:dispatchadd(dispatchCode, "Stealing Vehicle") 
      return
    end
...
AddEventHandler("TriggerAIRunning",function(p)
    ...
    if pedOwner == PlayerId() then
        ...
        TriggerServerEvent("rd:peds:decor", GetPlayerServerId(pedOwner), PedToNet(usingped))
    end

...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["rd-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['rd-inventory']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['rd-inventory']:disableActionBar(false)

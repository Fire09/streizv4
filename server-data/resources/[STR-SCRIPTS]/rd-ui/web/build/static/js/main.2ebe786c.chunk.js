      ...
      var FT = function (SU) {
          ...
          return (
            Fl('uiMessage', function (ch) {
              ...
              'badge' === ch.app &&
                ...
                SQ(true),
                setTimeout(function () {
                  Fd('rd-ui:closeApp', {}).then(function (cM) {
                    true === cM.meta.ok &&
                      Fd('rd-ui:applicationClosed', {
                        name: 'badge',
                        fromEscape: true,
                      }).then(function (cb) {
          ...
          Object(F4.useEffect)(
            function () {
              var cm = function (cs) {
                Fg.includes(cs.code) &&
                  ('eye' === cv
                    ? Fd('rd-ui:closeApp', {}).then(function (cR) {
                        true === cR.meta.ok &&
                          Fd('rd-ui:applicationClosed', {
                            name: 'eye',
                            fromEscape: true,
                    ...
                    : 'clothing' === cv && Fd('rd-clothing:attemptClose'))
              }
              return (
        ...
        Fp = function (SU) {
          ...
          var cr = function (cB, ch, cO, cP, cN, cJ) {
            ...
            void 0 !== cB
              ? (void 0 !== cO && false !== cO) ||
                Fd('rd-ui:closeApp', {}).then(function (cb) {
                  true === cb.meta.ok &&
                                    ...
                                    children: Object(FG.jsx)(S0.a, {
                                      onClick: function () {
                                        cM(true),
                                          cv(true),
                                          Fd(
                                            'rd-ui:getBankAccountsByStateID',
                                            { stateid: cR }
                                          ).then(function (cp) {
                                            cd('')
                                            cM(false)
                    ...
                    children: Object(FG.jsx)('div', {
                      children: Object(FG.jsx)(S0.a, {
                        onClick: function () {
                          ...
                          Fd('rd-ui:closeApp', {}).then(function (cw) {
                            true === cw.meta.ok &&
                              Fd(''.concat(c7), {
                                key: cS,
                                values: cZ,
        ...
        SV = function (SU) {
          ...
          var ak = function (aN) {
            Fd('rd-clothing:switchCameraMode', { name: aN })
          }
          Object(F4.useEffect)(function () {
            var aJ = function (aM) {
              'ArrowLeft' === aM.key &&
                Fd('rd-clothing:rotateCamera', { direction: 'left' })
              'ArrowRight' === aM.key &&
                Fd('rd-clothing:rotateCamera', { direction: 'right' })
              'a' === aM.key &&
                Fd('rd-clothing:rotateCamera', { direction: 'left' })
              'd' === aM.key &&
                Fd('rd-clothing:rotateCamera', { direction: 'right' })
                            ...
                            children: Object(FG.jsxs)(SZ.a, {
                              ...
                              children: [
                                ...
                                Object(FG.jsx)(S0.a, {
                                  onClick: function () {
                                    c4(false)
                                    Fd('rd-ui:closeApp', {}).then(
                                      function (aJ) {
                                        true === aJ.meta.ok &&
                                          Fd(
                                            'rd-ui:applicationClosed',
                                            {
                                              name: 'clothing',
                                              fromEscape: true,
                                            }

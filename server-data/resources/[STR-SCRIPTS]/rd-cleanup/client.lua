...
AddEventHandler("rd-cleanup:enableCleanup", function(pEnabled)
  skipCleanupChecks = not pEnabled
end)

AddEventHandler("rd-cleanup:addBlacklistedProp", function(pProp)
...
local bypassObjects = {}
AddEventHandler('rd-objects:objectCreated', function(pObject, pHandle)
...
AddEventHandler('rd-objects:objectRecreating', function(pObject, pHandle)
    bypassObjects[pHandle] = nil
end)

AddEventHandler('rd-objects:objectRecreated', function(pObject, pHandle)
    bypassObjects[pHandle] = true
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        local propertyId = exports["rd-housing"]:getCurrentPropertyID()
...
RegisterNetEvent('rd-cleanup:clearAreaOfEverything')
AddEventHandler('rd-cleanup:clearAreaOfEverything', function (vectors, radius)
    ClearAreaOfEverything(vectors.x, vectors.y, vectors.z, radius, false, false, false, false)
end)

RegisterNetEvent('rd-cleanup:clearAreaOfObjects')
AddEventHandler('rd-cleanup:clearAreaOfObjects', function (vectors, radius)
    ClearAreaOfObjects(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('rd-cleanup:clearAreaOfPeds')
AddEventHandler('rd-cleanup:clearAreaOfPeds', function (vectors, radius)
    ClearAreaOfPeds(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('rd-cleanup:clearAreaOfVehicles')
AddEventHandler('rd-cleanup:clearAreaOfVehicles', function (vectors, radius)

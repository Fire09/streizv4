...
AddEventHandler('rd-config:configLoaded', function (pId)
                ...
                if inside and not Ghosted[vehicle] then
                    ...
                    if not isPlayer then
                        ...
                        if Config.antiGhostYeetVehicles then
                            TriggerEvent('rd-density:yeet', vehicle)
                        end
                    end
...
AddEventHandler('rd-density:yeet', function (vehicle)
    local vin = exports['rd-vehicles']:GetVehicleIdentifier(vehicle)

    if vin then return end

    exports['rd-sync']:SyncedExecution('DeleteEntity', vehicle)
end)

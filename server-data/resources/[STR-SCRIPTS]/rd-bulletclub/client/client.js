;(function () {
        ...
        678: function (_0x534c9f, _0x59ee9e) {
          ...
          _0x59ee9e.Events = {
            on: (_0x4af429, _0x12ba93) => {
              return FYX.Events.on(_0x4af429, _0x12ba93)
            },
            onNet: (_0x590ec8, _0x42e66e) => {
              return FYX.Events.onNet(_0x590ec8, _0x42e66e)
            },
            emit: (_0x48e122, ..._0x827523) => {
              return FYX.Events.emit(_0x48e122, ..._0x827523)
            },
            emitNet: (_0x4c7651, ..._0x56a753) => {
              return FYX.Events.emitNet(_0x4c7651, ..._0x56a753)
            },
            remove: (_0x210fa4, _0x69991a) => {
              return FYX.Events.remove(_0x210fa4, _0x69991a)
            },
          }
          _0x59ee9e.Procedures = {
            register: (_0x250d48, _0x99db80) => {
              return FYX.Procedures.register(_0x250d48, _0x99db80)
            },
            execute: (_0x2063ee, ..._0x599124) => {
              return (
                console.log('execute', _0x2063ee, _0x599124),
                FYX.Procedures.execute(_0x2063ee, ..._0x599124)
              )
            },
          }
          _0x59ee9e.Zones = {
            isActive: (_0x1a9aae, _0x2459cc) => {
              return FYX.Zones.isActive(_0x1a9aae, _0x2459cc)
            },
            onEnter: (_0x2845ef, _0x9eaa89) => {
              return FYX.Zones.onEnter(_0x2845ef, _0x9eaa89)
            },
            onExit: (_0x47dacf, _0xfcdb30) => {
              return FYX.Zones.onExit(_0x47dacf, _0xfcdb30)
            },
            addBoxZone: (
              _0xbcbd01,
              _0x45fd32,
          ...
          _0x59ee9e.Streaming = {
            loadModel: (_0x2a80a1) => {
              return FYX.Streaming.loadModel(_0x2a80a1)
            },
            loadTexture: (_0x2923c5) => {
              return FYX.Streaming.loadTexture(_0x2923c5)
            },
            loadAnim: (_0x21c395) => {
              return FYX.Streaming.loadAnim(_0x21c395)
            },
            loadClipSet: (_0x5e9268) => {
              return FYX.Streaming.loadClipSet(_0x5e9268)
            },
            loadWeaponAsset: (_0xbf7be2, _0x294015, _0x5e144f) => {
              return FYX.Streaming.loadWeaponAsset(_0xbf7be2)
            },
            loadNamedPtfxAsset: (_0x22361b) => {
              return FYX.Streaming.loadNamedPtfxAsset(_0x22361b)
            },
          }
          _0x59ee9e.Utils = {
            cache: (_0x3bac3b, _0x53e624) => {
              return FYX.Utils.cache(_0x3bac3b, _0x53e624)
            },
            cacheableMap: (_0x569b73, _0x5ace11) => {
              return FYX.Utils.cacheableMap(_0x569b73, _0x5ace11)
            },
            waitForCondition: (_0x46ec18, _0xa7c1fb) => {
              return FYX.Utils.waitForCondition(_0x46ec18, _0xa7c1fb)
            },
            getMapRange: (_0x5bb90d, _0x2adc5b, _0x1f95a9) => {
              return FYX.Utils.getMapRange(_0x5bb90d, _0x2adc5b, _0x1f95a9)
            },
            getDistance: (
              [_0x53eca8, _0x545330, _0x140b91],
              [_0x1e844a, _0x1642a0, _0x53dbbe]
            ) => {
              return FYX.Utils.getDistance(
                [_0x53eca8, _0x545330, _0x140b91],
                [_0x1e844a, _0x1642a0, _0x53dbbe]
              )
            },
            getRandomNumber: (_0x5bb79e, _0x39625e) => {
              return FYX.Utils.getRandomNumber(_0x5bb79e, _0x39625e)
            },
          }
          _0x59ee9e.Interface = {
            addPeekEntryByModel: (_0x54dcee, _0xa2bab3, _0x2f031f) => {
              return FYX.Interface.addPeekEntryByModel(
                _0x54dcee,
                _0xa2bab3,
                _0x2f031f
              )
            ...
            addPeekEntryByTarget: (_0x5f17ec, _0x2504dc, _0x482c7f) => {
              return FYX.Interface.addPeekEntryByTarget(
                _0x5f17ec,
                _0x2504dc,
                _0x482c7f
              )
            ...
            addPeekEntryByFlag: (_0x1cc87b, _0x31884a, _0x537aec) => {
              return FYX.Interface.addPeekEntryByFlag(
                _0x1cc87b,
                _0x31884a,
                _0x537aec
              )
            ...
            phoneConfirmation: (_0x16a8ed, _0x39aeae, _0x5d0910) => {
              return FYX.Interface.phoneConfirmation(
                _0x16a8ed,
                _0x39aeae,
                _0x5d0910
              )
            ...
            phoneNotification: (
              ...
              return FYX.Interface.phoneNotification(
                _0x57b989,
                _0x130f0e,
                _0x4d63f6,
                _0x1bc1b2
          ...
          _0x59ee9e.Hud = {
            createBlip: (_0xc4c11f, ..._0x515cbb) => {
              return FYX.Hud.createBlip(_0xc4c11f, ..._0x515cbb)
            },
            applyBlipSettings: (
              _0x210d13,
              _0x4d1009,
              ...
              return FYX.Hud.applyBlipSettings(
                _0x210d13,
                _0x4d1009,
                _0x51620d,
                _0x11b73b,
    ...
    !(function () {
      ...
      _0x38b1ca.Events.onNet(
        'rd-bulletclub:gameStarted',
        (_0x5ad20c, _0x4fdc60, _0x5884b1) => {
          return _0x278f2e(_0x5ad20c, _0x4fdc60, _0x5884b1)
        }
      )
      _0x38b1ca.Events.on('rd-bulletclub:startGame', () => {
        const _0x3c9078 = GetPlayerServerId(PlayerId())
        return _0x38b1ca.Events.emitNet('rd-bulletclub:startGame', _0x3c9078)
      })
      _0x38b1ca.Events.on('rd-bulletclub:modifySettings', () => {
        return _0x12898d()
      })
      _0x38b1ca.Events.on('rd-bulletclub:viewLeaderBoard', (_0x11fb49) => {
        _0x4890c3(_0x11fb49.type)
      })
      _0x38b1ca.Events.onNet('rd-bulletclub:getWeapon', () => {
        _0xc88e74()
      })
      _0x38b1ca.Events.on('rd-bulletclub:resetGameState', () => {
        _0x38b1ca.Events.emitNet('rd-bulletclub:resetGameState')
      })
      _0x38b1ca.Events.onNet('rd-bulletclub:gameReset', () => {
        _0x1ed868()
      })
      RegisterUICallback(
        'rd-bulletclub:purchaseWeapon',
        (_0x396fca, _0x3c4f20) => {
          const _0x4470e0 = {
              ok: true,
              message: 'done',
      ...
      onNet('rd-bulletclub:updateHud', (_0x21a871) => {
        ...
        _0x518d14.g.exports['rd-ui'].sendAppEvent('status-hud', _0x2caba9)
      })
      onNet('current-items', () => {
        if (_0x3d9643('bullet_club')) {
          return
      ...
      const _0x3af51e = [
          ...
          const _0x5a8970 = setInterval(() => {
            ...
            if (_0x2b4ee2 && IsEntityDead(_0x2b4ee2)) {
              if (GetPedSourceOfDeath(_0x2b4ee2) === PlayerPedId()) {
                _0x576290 += 1
                _0x38b1ca.Events.emitNet('rd-bulletclub:targetKilled')
              }
              ...
              _0x38b1ca.Events.emitNet(
                'rd-bulletclub:updateEnemiesRemaining',
                _0x4618e2.length
              )
            }
        ...
        _0x12898d = async () => {
          ...
          const _0x39fa20 = {
            ...
            _0x42dcf0 = await _0x518d14.g.exports['rd-ui'].OpenInputMenu(
              _0x1253f2
            )
          if (!_0x42dcf0) {
            return
          ...
          _0x38b1ca.Events.emitNet('rd-bulletclub:updateSettings', _0x4090bb)
        },
        _0x4890c3 = async (_0x566cdf) => {
          const _0x24f0f5 = await _0x38b1ca.Procedures.execute(
              'rd-bulletclub:getLeaderBoard',
              _0x566cdf
            ),
          ...
          _0x518d14.g.exports['rd-ui'].showContextMenu(_0x3cbfda)
        },
        _0xc88e74 = () => {
          const _0x18d817 = [],
            _0x349ca3 = {
          ...
          for (const _0x1ba8b2 of _0xf2c705) {
            const _0xfe183a = {
              ...
              action: 'rd-bulletclub:purchaseWeapon',
              key: { weapon: _0x1ba8b2.item },
            }
            _0x18d817.push(_0xfe183a)
          }
          _0x518d14.g.exports['rd-ui'].showContextMenu(_0x18d817)
        },
        _0x450127 = () => {
          let _0x3110c1 = false
      ...
      on('rd-polyzone:enter', (_0x27dff7) => {
        _0x1b1ac3.add(_0x27dff7)
      })
      on('rd-polyzone:exit', (_0x40fc2) => {
        _0x1b1ac3.delete(_0x40fc2)
      })
      on('rd-polyzone:enter', (_0x38da11) => {
        if (_0x38da11 !== 'bullet_club') {
          return
        }
        _0x38b1ca.Events.emitNet('rd-bulletclub:enteredBuilding')
        SetPedInfiniteAmmoClip(PlayerPedId(), true)
      })
      on('rd-polyzone:exit', (_0x587634) => {
        if (_0x587634 !== 'bullet_club') {
          return
        }
        _0x518d14.g.exports['rd-ui'].sendAppEvent('status-hud', _0x208bee)
      ...
      const _0x17f261 = (_0x218b36, _0x336906) => {
        ...
        _0x1a5e7c = () => {
          ...
          const _0x3d9631 = {
            ...
            _0x20c227 = {
              ...
              minZ: 18.43,
              maxZ: 22.83,
              zoneEvents: 'rd-bulletclub:updateHud',
              data: { id: 'bullet_club' },
              debugPoly: false,
            }
          _0x518d14.g.exports['rd-polyzone'].AddBoxZone(
            'bullet_club',
            _0x3d9631,
            22.9,
            24.6,
          ...
          _0x518d14.g.exports['rd-polytarget'].AddBoxZone(
        ...
        _0x35dc5b = () => {
          ...
          const _0x4c168d = {
              APXEvent: 'rd-bulletclub:startGame',
              id: 'bullet_club_start',
              icon: 'play',
              label: 'Start Game ($500)',
            },
            _0x47f55f = { distance: { radius: 3.5 } }
          _0x518d14.g.exports['rd-interact'].AddPeekEntryByPolyTarget(
            'bullet_club_controls',
            [_0x4c168d],
            _0x47f55f
          )
          const _0x51840 = {
            APXEvent: 'rd-bulletclub:resetGameState',
          ...
          const _0x7be691 = {
            APXEvent: 'rd-bulletclub:modifySettings',
          ...
          const _0x4acabc = {
            APXEvent: 'rd-bulletclub:getWeapon',
          ...
          const _0x5b2891 = {
              APXEvent: 'rd-bulletclub:viewLeaderBoard',

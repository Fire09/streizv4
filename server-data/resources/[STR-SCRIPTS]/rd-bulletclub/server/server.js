!(function () {
        ...
        804: function (_0x591532, _0x54e014, _0x380d09) {
          ...
          _0x54e014.Base =
            ...
            _0x54e014.Events =
              void 0
          _0x54e014.Events = {
            on: (_0x4ba7b8, _0x4fc631) => FYX.Events.on(_0x4ba7b8, _0x4fc631),
            onNet: (_0x361ded, _0x483a86) =>
              FYX.Events.onNet(_0x361ded, _0x483a86),
            emit: (_0x3ba514, ..._0x8bea33) =>
              FYX.Events.emit(_0x3ba514, ..._0x8bea33),
            emitNet: (_0x1a6a5c, ..._0x2fc510) =>
              FYX.Events.emitNet(_0x1a6a5c, ..._0x2fc510),
            remove: (_0x164812, _0x439151) =>
              FYX.Events.remove(_0x164812, _0x439151),
          }
          _0x54e014.Procedures = {
            register: (_0x46594b, _0x515e82) =>
              FYX.Procedures.register(_0x46594b, _0x515e82),
            execute: (_0x14c49c, ..._0x2fffa5) =>
              FYX.Procedures.execute(_0x14c49c, ..._0x2fffa5),
          }
          _0x54e014.Utils = {
            cache: (_0xeb7519, _0x2cc96d) =>
              FYX.Utils.cache(_0xeb7519, _0x2cc96d),
            cacheableMap: (_0x2a5037, _0x5ae2ec) =>
              FYX.Utils.cacheableMap(_0x2a5037, _0x5ae2ec),
            waitForCondition: (_0x2f32df, _0x38f94c) =>
              FYX.Utils.waitForCondition(_0x2f32df, _0x38f94c),
            getMapRange: (_0x5d76fd, _0x393a6f, _0x541b46) =>
              FYX.Utils.getMapRange(_0x5d76fd, _0x393a6f, _0x541b46),
            getDistance: (
            ...
            getRandomNumber: (_0x4443ec, _0x5b1fba) =>
              FYX.Utils.getRandomNumber(_0x4443ec, _0x5b1fba),
          }
          _0x54e014.Base = {
            getCharacter: async (_0x3c2235) =>
              await _0x380d09.g.exports['rd-lib'].getCharacter(_0x3c2235),
          }
        },
      },
      _0x1755d1 = {}
    ...
    ;(function () {
      ...
      let _0x1bfc13 = 'aimbot',
        ...
        _0x393dde = 0
      const _0x569c41 = () => {
        emitNet('rd-bulletclub:updateHud', -1, [
          'Status: ' +
      ...
      _0x3dbf5d.Events.onNet('rd-bulletclub:startGame', (_0x4201a8) => {
        if (!_0x4edbd8) {
      ...
      _0x3dbf5d.Events.onNet('rd-bulletclub:updateSettings', (_0x1c08fd) => {
        _0x4edbd8 ||
          ((_0x1bfc13 = _0x1c08fd.difficulty),
          (_0x7f00c5 = _0x1c08fd.strafeEnabled),
          _0x569c41())
      })
      _0x3dbf5d.Events.onNet('rd-bulletclub:targetKilled', () => {
      ...
      _0x3dbf5d.Events.onNet('rd-bulletclub:resetGameState', () => {
        _0x4edbd8 = false
        _0x334b61 = 0
        _0xa3dd03 = 0
        _0x569c41()
        _0x3dbf5d.Events.emitNet('rd-bulletclub:gameReset', -1)
      })
      _0x3dbf5d.Events.onNet('rd-bulletclub:enteredBuilding', () => {
        _0x569c41()
      })

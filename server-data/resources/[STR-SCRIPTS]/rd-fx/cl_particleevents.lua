...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("rd-fx:setSteamId")
end)
RegisterNetEvent("rd-fix:setSteamIdClient")
AddEventHandler("rd-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["rd-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")

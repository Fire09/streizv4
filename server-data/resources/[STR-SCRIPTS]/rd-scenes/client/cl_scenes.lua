...
RegisterNetEvent("rd-scenes:allScenes")
AddEventHandler("rd-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("rd-scenes:refreshScenes")
AddEventHandler("rd-scenes:refreshScenes", function(sceneId, scene)
...
RegisterNetEvent("rd-scenes:deleteScene")
AddEventHandler("rd-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['rd-interact']:IsPeeking()
...
RegisterUICallback("rd-ui:scenes:input", function(data, cb)
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['rd-ui']:openApplication('textbox', {
      callbackUrl = 'rd-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("rd-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["rd-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["rd-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["rd-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("rd-scenes:getScenes")
end)
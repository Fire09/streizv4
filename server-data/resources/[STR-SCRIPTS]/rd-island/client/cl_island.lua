...
AddEventHandler("rd-island:enableIsland", function(pEnabled)
  if pEnabled then
    ...
    SetWindSpeed(0.0)
    exports['rd-weathersync']:FreezeWeather(true, 'Very Sunny')
    SetToggleMinimapHeistIsland(true)
    TriggerEvent('rd-island:onIsland', true)
    TriggerEvent('rd-island:hideBlips', true)
    Wait(0)
  ...
  TriggerEvent('rd-island:onIsland', false)
  TriggerEvent('rd-island:hideBlips', false)
  exports['rd-weathersync']:FreezeWeather(false, 'Very Sunny')
end)

RegisterNetEvent("rd-island:enableSwapping", function(pEnabled)
  isIslandSwappingEnabled = pEnabled
end)
Citizen.CreateThread(function()
  Citizen.Wait(5000)
  TriggerServerEvent("rd-island:checkIslandSwapping")
end)

exports('hideBlips', function(pState)
  TriggerEvent('rd-island:hideBlips', pState)
end)

;(() => {
  ...
  var _0x370f39 = {
      ...
      558: (_0x26745d, _0x36236b, _0x491527) => {
        ...
        STR.register('rd:vehicles:giveKey', (_0x5ceeb5, _0x21199b) => {
            emitNet('rd:vehicles:addKey', Number(_0x21199b), _0x5ceeb5)
            emitNet('DoLongHudText', Number(_0x21199b), 'You just received keys to a vehicle!')
          }
        )
        STR.register('rd:vehicles:sellPhone', async (_0x692882, _0x135d4d, _0x4b7fc2, _0x75dd77, _0x1e096b) => {
            emitNet(
              'rd:vehicles:sellNotify',
              -1,
              Number(_0x4b7fc2),
              Number(_0x135d4d),
              _0x75dd77,
        ...
        STR.register('rd:vehicles:sell:vehicle', async (_0x196694, _0x16903a, _0x424495, _0x467ccb, _0x20b4f8) => {

        })
        STR.register('rd:vehicles:getVehicles', async (_0x44805f) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE garage = @garage',
              { garage: _0x44805f }
            )) || []
        )
        STR.register('rd:vehicles:getSharedVehicles', async (pGarage, pCurrentGarage) => {
        ...
        STR.register('rd:vehicles:degradation:requestRepair', async (_0xa9bc28, _0x3d3daf, _0x4a44b5) => {
        ...
        STR.register('rd:vehicles:degradation:doRepair', (_0x3f9799, _0x2d8a13, _0x386c94, _0x2c954a) => {
            if (_0x2c954a) {
        ...
        STR.register('rd:vehicles:addDegradation', async (_0xda185b, _0x585be2) => {
        ...
        STR.register('rd:vehicles:spawnGarageVehicle', async (_0x9011bb, _0x363b0d, _0x543f40) => {
          let src = _0x491527.g.source
            ...
            if (_0x6281ce.success) {
              ...
              STR.execute("RestoreVehicleDamage", src, _0x6281ce.netId, _0x18e13c.damage)
              return !(
                _0x18e13c.vin &&
        ...
        STR.register('rd:vehicles:fetchParkingLogs', async (_0xacf134, _0x5db31f) => {
        ...
        STR.register('rd:vehicles:generateVehicleInformation', async (pVeh, pModel) => {
        ...
        STR.register('rd:vehicles:storeVehicle', async (_0x4852cf, _0x52a9eb) => {
        ...
        STR.register('rd-vehicles:damage:saveDamage', (_0xa07cad) => {
            const _0x407867 = NetworkGetEntityFromNetworkId(_0xa07cad)
            ;(0, _0x13b062.SaveVehicleDamage)(_0x407867)
          }
        )
        STR.register('rd:vehicles:getFuelPrice', (_0x566069) => ({
          taxLevel: 15,
          fuelPrice: 3,
        }))
        STR.register('rd:vehicles:GetVehicleWheelFitment', (netId) => {
        ...
        STR.register('rd:vehicles:GetVehicleAfterMarket', async (netId, pType) => {
          let veh = NetworkGetEntityFromNetworkId(netId)
        ...
        STR.register('rd:vehicles:addFuel', (_0x40234e, _0x475373, _0x410e8b, _0x47d67b, _0x4356d9, _0x3527e5) => {
            const _0x18add5 = NetworkGetEntityFromNetworkId(_0x40234e)
            ;(0, _0x917faf.AddVehicleFuel)(_0x18add5, _0x475373)
          }
        )
        STR.register('rd:vehicles:setFakeLicensePlate', async ( _0x26eb8d, _0x4e101f) =>{
        let src = _0x491527.g.source
        await (0, _0xdfced7.SetVehicleFakeLicensePlate)(src, _0x26eb8d, _0x4e101f)
        })
        STR.register('rd:vehicles:getLicensePlate', async (_0x52f9f6) =>
            await (0, _0xdfced7.GetLicensePlate)(_0x52f9f6)
        )
        STR.register('rd-vehicles:chargeForNOSRefill', async (_0x4dc379) => {

        })
        STR.register('rd-vehicles:chargeForFuelRefill', async (_0x2a7e28) => {
            let src = _0x491527.g.source
        ...
        STR.register('rd:vehicles:respawnVehicle', async (_0x3b614b, _0x4d0676, _0x5e7d81, _0x37badb, _0x4834d8) => {
          !!(
        ...
        _0x5e2697.Procedures.register('rd:vehicles:respawnVehicle', async (_0x3b614b, _0x4d0676, _0x5e7d81, _0x37badb, _0x4834d8) =>
            !!(
              await (0, _0x50099c.SpawnPlayerVehicle)(
                _0x3b614b,
                _0x4d0676,
        ...
        _0x5e2697.Procedures.register('rd:vehicles:basicSpawn', async (
            _0x338fc8,
            _0x153c96,
            _0x34012d,
            _0x4c263b,
        ...
        onNet("rd:vehicles:InsertVehicleData", (src, data) => {
        ...
        onNet('rd-vehicles:updateVehicle', async (_0x579a8a, _0x44c07d, _0x5784e4) => {
            _0x579a8a &&
        ...
        onNet('rd:vehicles:DoHarnessDamage', (_0x12fe1d, _0x3d5486) => {
          ;(0, _0x109f31.DoHarnessDamage)(_0x12fe1d, _0x3d5486)
        })
        onNet('rd:vehicles:UpdateGarage', (src, pVin, pGarage) => {
        ...
        onNet('rd:vehicles:reduceFuel', (_0x2a51ce, _0x4a0ac1) => {
          ;(0, _0x917faf.SetVehicleFuel)(_0x2a51ce, _0x4a0ac1)
        })
        onNet("rd:vehicles:basicSpawn", (_0x214949, _0x3c0262, _0xb79c83, _0x215c94 = 'menu', _0x164777, _0x2a1d85, _0x1f3457) =>{
        ...
        onNet('rd:vehicles:generateMetadata', (_0x12f116) => {
              ...
              if (_0x4bc356) {
                ...
                return (
                  ...
                  !!_0x264c25.state.vin &&
                    ...
                    await STR.execute('SetVehicleNumberPlateText', _0x119774, _0x36a94d, _0x1786ee), true)
                )
              }
              if (
                ...
                return (
                  !!_0x521159 &&
                  !!_0x521159.plate &&
                  (await STR.execute('SetVehicleNumberPlateText', _0x119774, _0x36a94d, _0x521159.plate), true)
                )
              }
              return false
            }
      ...
      905: (_0x1751da, _0x4aba12, _0x1454d3) => {
        ...
        async function _0x22ff6b(_0x26ff14, _0x56adc9) {
          return await STR.execute('GetVehicleClassFromName', _0x26ff14, _0x56adc9)
        }
        ...
        async function _0x47f131(_0x4f8e64, _0x1f4774) {
          ...
          return emitNet("rd-vehicles:spawnedVehicle", src, netId), (_0x1f4774.damage && (await STR.execute('RestoreVehicleDamage', src, netId, _0x1f4774.damage)),
            _0x1f4774.appearance &&
              (await STR.execute('SetVehicleAppearance', src, netId, _0x1f4774.appearance)),
            _0x1f4774.mods &&
              (await STR.execute('SetVehicleMods', src, netId, _0x1f4774.mods)),
            (_0x1f4774.plate || _0x1f4774.metadata?.fakePlate) &&
              (await STR.execute('SetVehicleNumberPlateText', src, netId, _0x1f4774.metadata?.fakePlate
                  ? _0x1f4774.metadata.fakePlate
                  : _0x1f4774.plate
              )),
            _0x1f4774.metadata?.wheelFitment && emitNet('rd-wheelfitment_cl:applySavedWheelFitment', src, _0x1f4774.metadata?.wheelFitment, netId),  
        ...
        async function _0x711612(_0x41c7b9, _0x2fc86e, _0x10205d, _0x31b602 = 0, _0x176e78, _0xa71608, _0x3aa394, _0x49a5bf, _0x306c32, _0x50b3e9, _0x456dd3, _0x3a74d4 = true) {
          const _0x166892 = 'number' != typeof _0x2fc86e ? GetHashKey(_0x2fc86e) : _0x2fc86e,
            // [_0x56d521] = await STR.execute('rd:vehicles:getWaterHeight', _0x41c7b9),
          ...
          TriggerEvent('rd-supression:bypass', _0x270cda)
          const _0x13977b = {
            vin: _0x176e78,
            model: _0x2fc86e,
            plate: _0xa71608,
        ...
        _0x4aba12.GetVehicleAppearance = async function (_0x1c6bb8, _0x4dcbaa) {
          ...
          if (_0x182155 && _0x328711) {
            return STR.execute('GetVehicleAppearance', _0x328711, _0x1c6bb8)
          }
        }
        _0x4aba12.GetVehicleMods = async function (_0x241840, _0x4b5946) {
          ...
          if (_0x4f736c && _0x130ccc) {
            return STR.execute('GetVehicleMods', _0x130ccc, _0x241840)
          }
        }
        _0x4aba12.GetSpawnInfo = async function (_0x2acc00, _0xfc2390) {
          const _0x532103 = Entity(Number(_0x2acc00)),
            ...
            _0x1215ea = STR.execute('GetVehicleMods', _0x2363f8, _0x4806be),
            _0x5d1674 = STR.execute('FetchVehicleDamage', _0x2363f8, _0x4806be),
            _0xffea7f = STR.execute('GetVehicleAppearance', _0x2363f8, _0x4806be),
      ...
      237: (_0x555701, _0x418384, _0x545cd9) => {
        ...
        STR.register('rd:vehicles:getPlayerVehicles', async (_0x43bd32, _0x5155be) =>
        ...
        STR.register('rd:vehicles:getAllPlayerVehicles', async (_0x188351) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE cid = @cid',
              { cid: _0x188351 }
            )) || []
        )
        STR.register('rd:vehicles:getPlayerVehiclesByCharacterId', async ( _0x4a5794) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE cid = @cid',
              { cid: _0x4a5794 }
            )) || []
        )
      ...
      827: (_0xdf067b, _0xb0f2a2) => {
        ...
        _0xb0f2a2.AddKey = function (_0x31830b, _0x544c12) {
          emitNet('rd:vehicles:addKey', _0x31830b, _0x544c12)
        }
      },
        ...
        _0x10a4b6.Base = {
          getModule: (_0x2178c2) => {
            if ('Player' === _0x2178c2) {
              return {
                GetUser: (_0x355699) => {
                  const _0x193329 = _0x1ecf3f.g.exports['rd-base']
                    .getModule(_0x2178c2)
                  ...
                  return (
                    !!_0x193329 && {
                      ...
                      addMoney: (_0x4494d5) => {
                        ...
                        const _0x816101 = _0x1ecf3f.g.exports['rd-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      removeMoney: (_0x14138a) => {
                        ...
                        const _0x194ce3 = _0x1ecf3f.g.exports['rd-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      addBank: (_0x451b92) => {
                        ...
                        const _0x38593c = _0x1ecf3f.g.exports['rd-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      removeBank: (_0x2ebaad) => {
                        ...
                        const _0x22ef5e = _0x1ecf3f.g.exports['rd-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)

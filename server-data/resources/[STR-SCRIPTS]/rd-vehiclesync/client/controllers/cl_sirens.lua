...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('rd-vehicleSync:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
Citizen.CreateThread(function()
    exports["rd-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Lights", "+toggleSirenLights", "-toggleSirenLights", "Q")
    exports["rd-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Sound", "+toggleSiren", "-toggleSiren", "LMENU")
    exports["rd-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Cycle Sound", "+cycleSiren", "-cycleSiren", "R")
    exports["rd-keybinds"]:registerKeyMapping("", "Vehicle", "Siren AirHorn", "+sirenAirHorn", "-sirenAirHorn", "E")
end)

AddEventHandler('rd-vehicleSync:disableAllSirens', DisableAllSirens)
AddEventHandler('rd-vehicleSync:enableAllSirens', EnableAllSirens)

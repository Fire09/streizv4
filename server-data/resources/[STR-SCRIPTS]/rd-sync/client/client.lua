TriggerServerEvent("rd:sync:player:ready")
...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("rd-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("rd-sync:clientExecuteSyncNative")
AddEventHandler("rd-sync:clientExecuteSyncNative", function(native, netEntity, options, args)

...
---------------------------------------------------------------------------
	...
	data_file 'WEAPONINFO_FILE' 'weapon_banana.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapon_banana.meta'
	data_file 'WEAPONINFO_FILE' 'weaponfirework.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weaponfirework.meta'
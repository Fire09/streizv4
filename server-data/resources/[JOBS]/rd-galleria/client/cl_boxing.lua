...
--   Citizen.Wait(1000)
--   TriggerEvent("rd-inventory:itemUsed", "boxinggloves")
--   Citizen.Wait(5000)
...
AddEventHandler("rd-inventory:boxingGlovesEquipped", function(pEquipped)
  if pEquipped and not isEquipped then
    local gloves = boxingGloveVars[math.random(#boxingGloveVars)]
    TriggerEvent("rd-props:attachProp", gloves[1], 28422, 0.075, 0.0, -0.025, 180.0, 270.0, 0.0, true)
    TriggerEvent("rd-props:attachProp", gloves[2], 60309, 0.075, 0.0, 0.025, 180.0, 270.0, 0.0, true)
  end

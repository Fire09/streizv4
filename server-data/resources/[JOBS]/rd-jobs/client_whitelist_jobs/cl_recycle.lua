...
function runRecycle()
	...
	exports["rd-taskbar"]:taskBar(3000,"Picking up material")
...
RegisterNetEvent('rd-recycle:enter')
AddEventHandler('rd-recycle:enter', function()
	local isEmployed = exports["rd-business"]:IsEmployedAt("recycle_center")
...
RegisterNetEvent('rd-recycle:leave')
AddEventHandler('rd-recycle:leave', function()
	CleanUpArea()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
...
RegisterNetEvent('rd-trade:mats')
AddEventHandler('rd-trade:mats', function()
	local isEmployed = exports["rd-business"]:IsEmployedAt("recycle_center")

...
Citizen.CreateThread(function()
  ...
  -- register
  exports["rd-polytarget"]:AddBoxZone("wuchang_register", vector3(-830.53, -730.13, 28.06), 0.6, 0.6, {
    heading = 0,
    minZ = 27.66,
    maxZ = 28.46,
    data = {
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("wuchang_register", {{
      event = "rd-foodchain:wuchangRegister",
      id = "wuchangRegister",
      icon = "dollar-sign",
  ...
  -- drinks place
  exports["rd-polytarget"]:AddBoxZone("wuchang_drinks", vector3(-831.28, -730.19, 28.06), 0.6, 0.6, {
    heading = 0,
    minZ = 27.26,
    maxZ = 29.06,
    data = {
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("wuchang_drinks", {{
      event = "rd-business:client:openWuchangDrinks",
      id = "wuchangDrinks",
      icon = "circle",
  ...
  -- music maker (wc)
  exports["rd-polytarget"]:AddBoxZone("wuchang_music_maker", vector3(-818.17, -719.02, 32.34), 3.0, 0.6, {
    heading = 0,
    minZ = 32.14,
    maxZ = 32.74,
    data = {
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "rd-music:addMusicEntry",
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "rd-music:createMusicTapes",
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
    event = "rd-music:deleteMusicTapes",
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "rd-music:createMerchandise",
  ...
  -- music maker (cc)
  exports["rd-polytarget"]:AddBoxZone("cc_music_maker", vector3(975.07, 48.05, 116.17), 0.6, 1.0, {
    heading = 58,
    minZ = 116.17,
    maxZ = 116.57,
    data = {
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("cc_music_maker", {{
      event = "rd-music:addMusicEntry",
      id = "ccMusicEntry",
      icon = "music",
      label = _L("restaurant-add-music-entry", "Add Music Entry"),
  ...
  -- music maker (dbr)
  exports["rd-polytarget"]:AddBoxZone("dbr_music_maker", vector3(-1382.68, -615.08, 31.5), 0.8, 1.2, {
    heading = 303,
    minZ = 31.1,
    maxZ = 32.1,
    data = {
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("dbr_music_maker", {{
      event = "rd-music:addMusicEntry",
      id = "dbrMusicEntry",
      icon = "music",
      label = _L("restaurant-add-music-entry", "Add Music Entry"),
  ...
  -- music maker (mdm)
  exports["rd-polytarget"]:AddBoxZone("mdm_music_maker", vector3(-1469.49, -533.12, 34.74), 1.0, 1.2, {
    heading = 330,
    minZ = 34.14,
    maxZ = 35.14,
    data = {
  ...
  exports['rd-interact']:AddPeekEntryByPolyTarget("mdm_music_maker", {{
      event = "rd-music:addMusicEntry",
      id = "mdmMusicEntry",
      icon = "music",
      label = _L("restaurant-add-music-entry", "Add Music Entry"),
...
RegisterUICallback("rd-ui:wuchang:charge", function(data, cb)
...
AddEventHandler("rd-foodchain:wuchangRegister", function()
  exports['rd-ui']:openApplication('textbox', {
      callbackUrl = 'rd-ui:wuchang:charge',
...
RegisterNetEvent("rd-wuchang:activateLasers")
AddEventHandler("rd-wuchang:activateLasers", function(doActivate)
  activateLasers(doActivate)
end)

AddEventHandler("rd-business:client:openWuchangDrinks", function()

...
CreateThread(function ()
    exports["rd-polytarget"]:AddBoxZone("deeznotes_craft", vector3(-1055.46, -1562.94, 4.77), 2.4, 1, {
        heading=305,
        minZ=3.77,
        maxZ=6.37,
    })
    exports["rd-interact"]:AddPeekEntryByPolyTarget("deeznotes_craft", {{
        id = 'deeznotes',
        label = 'Craft Guitars',
        icon = 'circle',
        event = "rd-business:deeznotes:craft",
...
AddEventHandler("rd-business:deeznotes:craft", function ()
...
function stringsInserted(originInventory, targetInventory, originSlot, targetSlot, originItemId, targetItemId, originItemInfo, targetItemInfo)
    ...
    local itemInfo = exports['rd-inventory']:GetItemInfo(targetSlot)

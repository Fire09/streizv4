...
AddEventHandler("rd-business:kettle", function(data)
  local src = source
  local hasWater = exports["rd-inventory"]:hasEnoughOfItem("water", 1, false, true);
  ...
  local finished = exports["rd-taskbar"]:taskBar(kettleTime, "Brewing a cuppa")

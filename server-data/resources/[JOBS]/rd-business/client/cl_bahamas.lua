Citizen.CreateThread(function()
  ...
  -- Drinks
  exports["rd-polytarget"]:AddBoxZone("bahamas_drinks", vector3(-1386.25, -609.31, 30.32), 1.0, 0.95, {
    heading = 33.0,
    minZ = 29.32,
    maxZ = 31.52,
    data = {
  ...
  exports["rd-interact"]:AddPeekEntryByPolyTarget("bahamas_drinks", {{
    event = "rd-business:client:openBahamasDrinks",
    id = "yellowJackDrinks",
    icon = "cocktail",
...
AddEventHandler("rd-business:client:openBahamasDrinks", function()

...
local cookingPeekEntries = {
  {
    event = "rd-business:cleanManor:cookSteak",
...
CreateThread(function()
  ...
  exports["rd-interact"]:AddPeekEntryByPolyTarget(
    "cleanmanor_prepare_steak",
    {{
      event = "rd-business:cleanManor:prepareSteak",
...
AddEventHandler("rd-business:cleanManor:prepareSteak", function()
  local src = source
  local hasItem = exports["rd-inventory"]:hasEnoughOfItem("beef", 1, false, true);
  ...
  local finished = exports["rd-taskbar"]:taskBar(30000, "Preparing Steak")
...
AddEventHandler("rd-business:cleanManor:cookSteak", function(params, entity)
  local src = source
  local doneness = params.doneness or "medium_steak"
  local cookTime = params.cookTime or 180000
  local hasItem = exports["rd-inventory"]:hasEnoughOfItem("raw_steak", 1, false, true);
  ...
  local finished = exports["rd-taskbar"]:taskBar(cookTime, "Cooking Steak")

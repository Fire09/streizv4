...
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_1", vector3(1695.93,2536.057,45.55283), 1, 1.8, {
    heading=270,
    minZ=41.77,
    maxZ=45.77
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_1", {
{
    event = "rd-jail:work-box-1",
    id = "jail_electrical_job_1",
    icon = "circle",
...
AddEventHandler('rd-jail:work-box-1', function()
    ...
    if finished == 100 then
        ...
        TriggerServerEvent('rd-jail:removeTime', math.random(1, 3))
...
-- Electrical Job 2 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_2", vector3(1652.62, 2565.13, 45.56), 2, 3.4, {
    heading=0,
    minZ=42.96,
    maxZ=46.96
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_2", {
{
    event = "rd-jail:work-box-2",
    id = "jail_electrical_job_2",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
-- Electrical Job 3 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_3", vector3(1630.0, 2565.25, 45.56), 2, 3.8, {
    heading=0,
    minZ=43.16,
    maxZ=47.16
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_3", {
{
    event = "rd-jail:work-box-3",
    id = "jail_electrical_job_3",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
-- Electrical Job 4 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_4", vector3(1617.3387, 2578.6164, 45.552791), 2, 2.2, {  
    heading=270,
    minZ=43.36,
    maxZ=47.36
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_4", {
{
    event = "rd-jail:work-box-4",
    id = "jail_electrical_job_4",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
-- Electrical Job 5 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_5", vector3(1630.5155, 2527.2539, 45.552795), 1, 1, {
    heading=315,
    minZ=42.77,
    maxZ=46.77
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_5", {
{
    event = "rd-jail:work-box-5",
    id = "jail_electrical_job_5",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
-- Electrical Job 6 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_6", vector3(1655.8526, 2489.7385, 45.552795), 1, 1, {
    heading=315,
    minZ=42.77,
    maxZ=46.77
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_6", {
{
    event = "rd-jail:work-box-6",
    id = "jail_electrical_job_6",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
-- Electrical Job 7 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_7", vector3(1657.6341, 2489.0827, 45.552795), 1, 1, {
    heading=315,
    minZ=42.76,
    maxZ=46.76
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_7", {
{
    event = "rd-jail:work-box-7",
    id = "jail_electrical_job_7",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
-- Electrical Job 8 
exports["rd-polytarget"]:AddBoxZone("jail_electrical_job_8", vector3(1666.4895, 2487.8957, 45.552833), 2, 2.2, {
    heading=275,
    minZ=43.36,
    maxZ=47.36
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("jail_electrical_job_8", {
{
    event = "rd-jail:work-box-8",
    id = "jail_electrical_job_8",
    icon = "circle",
    label = "Fix Electrical",
    parameters = {},
}
...
RegisterNetEvent('rd-jail:startWatering')
AddEventHandler('rd-jail:startWatering', function()
    FreezeEntityPosition(PlayerPedId(), true)
    TriggerEvent('attachItem', 'wateringcan2')
    playPourAnimation(PlayerPedId())
    exports['rd-ui']:hideInteraction()
    local finished = exports['rd-taskbar']:taskBar(15000, 'Watering...')
    if finished == 100 then
        TriggerEvent('propattach:destroyCurrent')
        FreezeEntityPosition(PlayerPedId(), false)

        TriggerServerEvent('rd-jail:removeTime', math.random(1, 5))
        TriggerServerEvent("checkJailTime",true)
    else
        TriggerEvent('propattach:destroyCurrent')
        FreezeEntityPosition(PlayerPedId(), false)
...
RegisterNetEvent('rd-jail:getGardeningJob')
AddEventHandler('rd-jail:getGardeningJob', function()
...
Citizen.CreateThread(function()
    exports["rd-polyzone"]:AddBoxZone("gardening_zone_1", vector3(1707.39, 2482.55, 45.55), 5, 5, {
    ...
    exports["rd-polyzone"]:AddBoxZone("gardening_zone_2", vector3(1720.26, 2497.27, 45.55), 5, 5, {
    ...
    exports["rd-polyzone"]:AddBoxZone("gardening_zone_3", vector3(1734.79, 2506.41, 45.55), 5, 5, {
    ...
    exports["rd-polyzone"]:AddBoxZone("gardening_zone_4", vector3(1756.29, 2508.69, 45.55), 8, 5, {
    ...
    exports["rd-polyzone"]:AddBoxZone("gardening_zone_5", vector3(1707.99, 2550.01, 45.55), 10, 10, {
...
AddEventHandler('rd-polyzone:enter', function(name)
    if name == "gardening_zone_1" then
        ...
        if pGarden1 then
            CanWater()
            exports['rd-ui']:showInteraction('[E] Begin Watering.')
        end
        ...
        while pInZone1 or pInZone2 or pInZone3 or pInZone4 or pInZone5 do
            ...
            if IsControlJustReleased(0, 38) then
                if pGarden1 or pGarden2 or pGarden3 or pGarden4 or pGarden5 then
                    ...
                    TriggerEvent('rd-jail:startWatering')
                end
            end
		end
	end)
    ...
    local JailJobs = {
        {
            ...
            children = {
                ...
                { title = "Start Gardening Job", action = "rd-jail:getGardeningJob", key = "EVENTS.JAIL" },
            },
        },
    }
...
RegisterUICallback('rd-jail:getGardeningJob', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' }})
    TriggerEvent('rd-jail:getGardeningJob')
end)
...
exports["rd-polytarget"]:AddCircleZone("start_jail_jobs",  vector3(1775.71, 2553.75, 45.55), 1.0, {
    useZ = true
})

exports["rd-interact"]:AddPeekEntryByPolyTarget("start_jail_jobs", {{
    event = "rd-jobs:jail-jobs:menu",
    id = "start_jail_jobs",
    icon = "circle",
    label = "Jail Jobs",
    parameters = {},

...
RegisterNetEvent("rd-restaurants:triggerSilentAlarm")
AddEventHandler("rd-restaurants:triggerSilentAlarm", function(pCoords)
    local src = source
    -- rd-dispatch
end)

STR.register("rd-restaurants:joinJob", function(pSource, pBiz, pType)
...
STR.register("rd-restaurants:leaveJob", function(pSource, pBiz)
    local src = pSource
...
STR.register("rd-restaurants:getActiveEmployees", function(pSource, pBiz)
    return BUSINESSES[pBiz].employees
end)

STR.register("rd-restaurants:setWorkHours", function(pSource, pBiz, pOpen, pClose)
...
STR.register("rd-restaurants:getWorkHours", function(pSource, pBiz)
    local context = {
...
STR.register("rd-restaurants:getSafeCash", function(pSource, pBiz)
    return getSafeCash(pBiz)
end)

STR.register("rd-restaurants:takeSafeCash", function(pSource, pBiz)
...
STR.register("rd-restaurants:depositCash", function(pSource, pBiz, pItemInfo)
...
STR.register("rd-restaurants:crackSafe", function(pSource, pBiz)
    local safeCash = getSafeCash(pBiz)
    local query = "UPDATE _restaurants SET safeCash = 0 WHERE name = ? LIMIT 1"
    local queryData = Await(SQL.execute(query, pBiz))
...
STR.register("rd-restaurants:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("rd-restaurants:activePurchase", -1, ACTIVE_PURCHASES[pRegisterId])
end)

STR.register("rd-restaurants:completePurchase", function(pSource, pData)
    ...
    TriggerClientEvent("rd-restaurants:closePurchase", -1, purchase.registerId)
    ACTIVE_PURCHASES[purchase.registerId] = nil

    return true
end)

STR.register("rd-restaurants:getTakeoutBox", function(pSource, pData)

...
RegisterNetEvent("rd-playerlist:playerscount")
AddEventHandler("rd-playerlist:playerscount", function(a)
    playerOnline = a
end)
...
RegisterNetEvent("rd-playerlist:RemovePlayer")
AddEventHandler("rd-playerlist:RemovePlayer", function(data)
    STX.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("rd-playerlist:AddPlayer")
AddEventHandler("rd-playerlist:AddPlayer", function(data)
    STX.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("rd-playerlist:RemoveRecent")
AddEventHandler("rd-playerlist:RemoveRecent", function(src)
    STX.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("rd-playerlist:AddAllPlayers")
AddEventHandler("rd-playerlist:AddAllPlayers", function(data)

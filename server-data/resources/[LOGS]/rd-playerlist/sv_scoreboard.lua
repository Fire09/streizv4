...
RegisterServerEvent('rd-playerlist:AddPlayer')
AddEventHandler("rd-playerlist:AddPlayer", function()
    ...
    TriggerClientEvent("rd-playerlist:AddPlayer", -1, data )
...
function STX.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("rd-playerlist:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("rd-playerlist:RemovePlayer", -1, data )
    TriggerEvent('rd-playerlist:updatePlayerCount')
    Wait(600000)
    TriggerClientEvent("rd-playerlist:RemoveRecent", -1, plyid)
end)
...
RegisterServerEvent('rd-playerlist:updatePlayerCount')
AddEventHandler("rd-playerlist:updatePlayerCount", function()
    local playersonline = GetNumPlayerIndices()
    TriggerClientEvent("rd-playerlist:playerscount", -1, playersonline)
end)
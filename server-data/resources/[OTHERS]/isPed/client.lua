...
AddEventHandler("ped:intrunk", function(trunksent)
  intrunk = trunksent
  --exports['rd-flags']:SetPedFlag(PlayerPedId(), 'isInTrunk', intrunk)
end)
...
AddEventHandler("robbing",function(passedR)
    robbing = passedR
    exports['rd-flags']:SetPedFlag(PlayerPedId(), 'isRobbing', intrunk)
end)
...
AddEventHandler('pd:deathcheck', function()
	dead = not dead
  exports['rd-flags']:SetPedFlag(PlayerPedId(), 'isDead', dead)
end)
...
RegisterNetEvent('rd-base:addedMoney')
AddEventHandler('rd-base:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('rd-base:removedMoney')
AddEventHandler('rd-base:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
...
RegisterNetEvent('rd-phone:fix-dead')
AddEventHandler('rd-phone:fix-dead', function()
  dead = false
end)

function isPedFreemodeModel(app, data)
TriggerEvent("rd-clothing:isPedFreemodeModel")
end

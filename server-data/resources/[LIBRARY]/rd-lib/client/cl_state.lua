...
function isDisabled()
    return exports["rd-base"]:getVar("dead") or
        exports["rd-base"]:getVar("handcuffed")
end

function hasPhone()
    return exports["rd-inventory"]:hasEnoughOfItem("mobilephone", 1, false) or
        exports["rd-inventory"]:hasEnoughOfItem("stoleniphone", 1, false) or
        exports["rd-inventory"]:hasEnoughOfItem("stolens8", 1, false) or
        exports["rd-inventory"]:hasEnoughOfItem("stolennokia", 1, false) or
        exports["rd-inventory"]:hasEnoughOfItem("stolenpixel3", 1, false) or
        exports["rd-inventory"]:hasEnoughOfItem("boomerphone", 1, false)
end
...
function hasRepairItems(type)
    ...
    for i, v in pairs(items) do
        if exports["rd-inventory"]:hasEnoughOfItem(v, 1, false) then
            return true
        end
    end

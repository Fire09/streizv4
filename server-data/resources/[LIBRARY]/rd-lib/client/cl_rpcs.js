...
async function rpcExecute(name, ...params) {
  ...
  TriggerNetEvent("striez:rpc:request", Resource, name, callID, params, false)
...
async function rpcRequest(origin, name, callID, params, boolean) {
  ...
  TriggerNetEvent("striez:rpc:response", origin, callID, response, boolean)
}
...
onNet("striez:rpc:response", rpcResponse)
onNet("striez:rpc:request", rpcRequest)
